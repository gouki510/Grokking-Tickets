...
class Exp(object):
    def __init__(self) -> None:
        ...
        self.seed = 0 
        self.root = Path("0921/prune") 
        self.pre_root = Path("0919")
        ...
        self.weight_path = self.pre_root/self.exp_name/"10000.pth"
        ...
        self.exp_name = f"{self.model}_{self.pruner}_PR_{self.num_layers}L_{self.d_model}D_{self.p}P_\
            ...
            {self.weight_scale}WS_{fn_name}task_{self.reinitialize}_reinit"
