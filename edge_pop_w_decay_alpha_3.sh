...
CUDA_VISIBLE_DEVICES=2 python train_slth.py -o adam -w 3 -l 0.01 -s $s --width_ratio 1 --weight_init_path /workspace/Grokking-Tickets/0120/slth/WIDTHRATIO_1_WEIGHTLR_True/400.pth --pruning_rate 0.4 --exp_tag edge_pop_wo_decay --weight_learning --double_reg
s=1
